...
def get_embeddings():
    ...
    if EMBEDDINGS_CACHE is None:
        EMBEDDINGS_CACHE = HuggingFaceEmbeddings(model_name=EMBEDDING_MODEL_NAME)
...
# Download and Save
# -------------------------
async def download_and_save_vector_store_by_folder(user_id: str, folder_id: str) -> str:
    try:
...
def load_vector_store(vector_store_path: str):
    ...
    return VectorStoreCache.get_vector_store(vector_store_path)
